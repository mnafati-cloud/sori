# -*- coding: utf-8 -*-
"""Icônes PWA « Encre & sceau » (v73) : fond encre pleine surface (maskable),
소리 en Nanum Myeongjo Bold (hanji), carré-sceau vermillon incliné en signature.
...
Rendu en 4x puis réduction LANCZOS (bords nets). Zone sûre maskable : 80 % centraux.
"""
import sys
from PIL import Image, ImageDraw, ImageFont

INK, HANJI, SEAL = (16, 20, 27, 255), (237, 233, 224, 255), (228, 88, 74, 255)
